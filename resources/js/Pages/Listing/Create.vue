    ...
    <form @submit.prevent="create">
        <div class="grid grid-cols-6 gap-4">
            <div class="col-span-2">
                ...
                <div class="text-red-500" v-if="form.errors.beds">
                    {{ form.errors.beds }}
                </div>
            </div>
            <div class="col-span-2">
                ...
                <div class="text-red-500" v-if="form.errors.baths">
                    {{ form.errors.baths }}
                </div>
            </div>
            <div class="col-span-2">
                ...
                <div class="text-red-500" v-if="form.errors.area">
                    {{ form.errors.area }}
                </div>
            </div>
            <div class="col-span-4">
                ...
                <div class="text-red-500" v-if="form.errors.city">
                    {{ form.errors.city }}
                </div>
            </div>
            <div class="col-span-2">
                ...
                <div class="text-red-500" v-if="form.errors.code">
                    {{ form.errors.code }}
                </div>
            </div>
            <div class="col-span-4">
                ...
                <div class="text-red-500" v-if="form.errors.street">
                    {{ form.errors.street }}
                </div>
            </div>
            <div class="col-span-2">
                ...
                <div class="text-red-500" v-if="form.errors.street_nr">
            ...
            <div class="col-span-6">
                ...
                <div class="text-red-500" v-if="form.errors.price">
                    {{ form.errors.price }}
                </div>
            </div>
            <div class="col-span-6">
